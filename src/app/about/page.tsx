      ...
      <div className="max-w-6xl mx-auto px-4 w-full">
        <section className="mb-12">
          ...
          <p className="text-lg text-page-text-muted leading-relaxed">
            Personifine is a website created to showcase my writing in a clean,
            ad‑free format. This is in contrast to sites such as Wattpad, which,
            in my opinion, do not present a convenient reading experience. I
            wanted to amend that. In its current form, the website is tailored
            for my personal writings, but I would love to hear from any
        ...
        <section className="flex flex-col md:flex-row items-center md:items-center gap-8">
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center">
            ...
            <p className="mt-4 text-lg text-page-text-muted leading-relaxed">
              Thank you for visiting Personifine; I hope you enjoyed the stories
