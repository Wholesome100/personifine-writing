      ...
      <div className="max-w-5xl mx-auto px-4 w-full">
        <section className="mb-8">
          ...
          <p className="text-page-text-muted max-w-prose">
            Thank you for your interest! If you would like to contribute a story
            to Personifine, please provide a username, a contact email where you
            can be reached, and a brief pitch for what you plan to write.
          </p>
        </section>
